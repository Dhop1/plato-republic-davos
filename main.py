...
try:
    ...
    print("Using model: models/gemini-1.5-flash-001")
except Exception as e:
    print(f"gemini-1.5-flash-001 unavailable ({e}), falling back to models/gemini-pro")
    ...
    if convo['lesson_id']:
        ...
        if lesson:
            ...
            context = (
                ...
                "Good: Safety is an illusion. It is a pathology of the weak.\n\n"
...
def submit_reflection(lesson_id):
    ...
    analysis_prompt = (
        ...
        "4. SOURCE HANDLING (THE GURU RULE): You MAY cite Plato, 'The text,' or 'The book' explicitly. "
        ...
        "Bad: The transcript mentions that safety is an illusion. Good: Safety is an illusion. It is a pathology of the weak.\n\n"
        "5. NO AIR QUOTES: Do not use quotation marks around concepts from the transcripts. These are YOUR thoughts. "
        "Only use quotation marks when quoting a third party (e.g., Socrates, Glaucon). "
